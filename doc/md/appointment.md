...
Luego de realizar el pago, el cliente accederá a una interfaz para solicitar un turno. Deberá elegir de una lista desplegable la fecha (No posterior a 4 semanas) y luego seleccionar entre los horarios disponibles:
...
Luego de reservar el turno la operación pasará al estado “Verificación pendiente” y el usuario será redireccionado a una interfaz con los datos de su reserva:
