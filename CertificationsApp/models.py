...
class Vehicle(models.Model):    
    ...
    original_type = models.ForeignKey(ModificationsType, related_name='originaltype', on_delete=models.SET_NULL, null=True)
    final_type = models.ForeignKey(ModificationsType, related_name='finaltype', on_delete=models.SET_NULL, null=True)
...
class Operation(models.Model):    
    ...
    paid_at = models.DateTimeField(default=None) #Puede llegar a joder el None
    ...
    id_vehicle = models.ForeignKey(Vehicle, related_name='operation', on_delete=models.SET_NULL, null=True) 
